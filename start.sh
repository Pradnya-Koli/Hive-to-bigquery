...
export from_path="hdfs://accelerator-hive-bq-m/user/hive/warehouse/hivedemo.db/"
...
case "$script_number" in
  ...
  "3")
    ...
    "1")
      ...
      python3 main.py --source ADD_COLUMNS
      ;;
    "2")
      echo "executing the rename column function..........."  
      python3 main.py --source RENAME_COLUMN
      ;;
    "3")
      echo "executing the drop column function........"
      python3 main.py --source DROP_COLUMN
      ;;
    *)
