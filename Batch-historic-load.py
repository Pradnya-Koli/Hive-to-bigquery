...
def distcp(from_path: str, to_path: str) -> None:
  ...
  check_call(['hadoop', 'distcp', '-direct', from_path, to_path], stderr=subprocess.STDOUT)
  print("=====================HIVE TO GCS======================================")
...
#       to_path="gs://demo-gcs-bq"
        ...
        job_config = bigquery.LoadJobConfig(
            source_format=bigquery.SourceFormat.ORC, autodetect=True,
        )
        prefix1= element + '/'
        # print("Prefix ",prefix)
...
if __name__ =="__main__":
    ...
    with open("config.json") as config_file:
        ...
        conn = hive.Connection(host=data['details']['server'],
