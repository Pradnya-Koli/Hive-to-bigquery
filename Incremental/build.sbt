...
libraryDependencies += "com.google.cloud.spark" %% "spark-bigquery-with-dependencies" % "2.12-0.29" from "file:///opt//spark-bigquery-with-dependencies_2.12-0.29.0.jar"
libraryDependencies += "com.hortonworks.hive" %% "hive-warehouse-connector-spark3" % "1.0.0.1.18.7215.0-43" from "file:///opt//hive-warehouse-connector-spark3_2.12-1.0.0.1.18.7215.0-43.jar"
